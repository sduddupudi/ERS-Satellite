            ...
            <?php if ($row_lobby['breakout_6_appears'] == 'yes') { ?>
                <div class="icon_div video_confrence">
                    ...
                    <div class="icon_div_hover">
                        <a href="<?php if (isset($row_lobby['breakout6_join_video_conference'])) {
                            echo $row_lobby['breakout6_join_video_conference'];
                        } ?>" target="_blank">
                            <img src="assets/images/Icone_videoconference.png">
                            <p><?php if (isset($row_lobby['ihd_cosentyx_spa_btn_text'])) {
                                    echo $row_lobby['ihd_cosentyx_spa_btn_text'];
                                } ?></p>
                        </a>
                    </div>
                </div>
