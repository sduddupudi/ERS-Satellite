...
?>
    ...
    <div id="main-wrapper">
        ...
        <div id="breakout_2" class="right_content" style="background-image: url(assets/images/conf_2.png);">
            <?php if ($row_lobby['breakout_2_appears'] == 'yes') { ?>
                <div class="icon_div video_confrence">
                    ...
                    <div class="icon_div_hover">
                        <a href="<?php if (isset($row_lobby['breakout2_join_video_conference'])) {
                            echo $row_lobby['breakout2_join_video_conference'];
                        } ?>" target="_blank">
                            <img src="assets/images/Icone_videoconference.png">
                            <p><?php if (isset($row_lobby['gp2_btn_text'])) {
                                    echo $row_lobby['gp2_btn_text'];
                                } ?></p>
                        </a>
                    </div>
                </div>
